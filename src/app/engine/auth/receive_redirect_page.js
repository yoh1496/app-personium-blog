  ...
  return {
    ...
    body: [
      [
        ...
        '<div id="statusText">Sending auth data to your app...</div>',
        '</div>',
        '<script type="text/javascript">',
        '  function receiveMessage(event) {',
        '    if (event.origin !== "https://yoh1496.github.io" && event.origin !== "https://localhost:8080") {',
        '      return;',
        '    }',
        ...
        '      state: "' + state + '",',
        '    }, event.origin);',
        '    document.getElementById("statusText").innerText = "Sending auth data is done. Please close this window.";',
        '  }',
